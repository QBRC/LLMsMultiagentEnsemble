...
class LLMApp:
    ...
    def compute(self):
        ...
        new_cols = pd.DataFrame(None, index=df.index, columns=self.json_key_list)
    ...
    def make_batch_call(self,
        ...
        for index, row in df.iterrows():
            ...
            print(f"\r{str(index)}:  {case_id} {' '*30}", end='', flush=True)
            ...
            if report == '':
                ...
                if response is None:
                    ...
                    if not response_content: 
                        ...
                        # keep current completed, if index % 100 == 0
